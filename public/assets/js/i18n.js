...
(() => {
  ...
  const messages = {
    en: {
      ...
      "blog.title": "Blog",
      "blog.intro": "How I build graphics tools, learn in public, and keep this corner of the web running.",
    ...
    ja: {
      ...
      "blog.eyebrow": "開発ノート",
      "blog.title": "ブログ",
      "blog.intro": "グラフィックスツールの開発、学び、そしてこのサイトの運用について書いています。",
    ...
    "zh-CN": {
      ...
      "blog.eyebrow": "开发笔记",
      "blog.title": "博客",
      "blog.intro": "记录图形工具开发、公开学习，以及这个网站的维护过程。",
      "blog.loading": "正在加载文章…",
