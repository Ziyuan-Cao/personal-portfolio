...
(() => {
  ...
  const messages = {
    en: {
      ...
      "news.reload": "Refresh view",
      "news.reloading": "Refreshing view…",
      ...
      "news.collectionHealthy": "{collected} · {succeeded}/{attempted} sources succeeded",
      "news.collectionPartial": "{collected} · {failed}/{attempted} sources failed; last good items retained",
    ...
    ja: {
      ...
      "news.collectionHealthy": "{collected}・{succeeded}/{attempted}件の情報源を収集",
      "news.collectionPartial": "{collected}・{failed}/{attempted}件の情報源で失敗（前回成功時の項目を保持）",
    ...
    "zh-CN": {
      ...
      "news.collectionHealthy": "{collected} · {succeeded}/{attempted} 个来源采集成功",
      "news.collectionPartial": "{collected} · {failed}/{attempted} 个来源失败（已保留上次成功采集的内容）",
